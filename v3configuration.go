...
func (r *V3ConfigurationService) New(ctx context.Context, body V3ConfigurationNewParams, opts ...option.RequestOption) (res *Configuration, err error) {
...
func (r *V3ConfigurationService) Update(ctx context.Context, configuration string, body V3ConfigurationUpdateParams, opts ...option.RequestOption) (res *Configuration, err error) {
	opts = slices.Concat(r.Options, opts)
	if configuration == "" {
...
// List configurations
func (r *V3ConfigurationService) List(ctx context.Context, opts ...option.RequestOption) (res *[]Configuration, err error) {
	opts = slices.Concat(r.Options, opts)
	path := "v3/configurations"
...
// Get configuration
func (r *V3ConfigurationService) Show(ctx context.Context, configuration string, opts ...option.RequestOption) (res *Configuration, err error) {
	opts = slices.Concat(r.Options, opts)
	if configuration == "" {
		err = errors.New("missing required configuration parameter")
		return nil, err

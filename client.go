...
// interacting with the qanapi API. You should not instantiate this client
...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("QANAPI_API_KEY"); ok {
...
// environment (QANAPI_API_KEY, QANAPI_SUBDOMAIN, QANAPI_BASE_URL). The option

...
// RequestOption is an option for the requests made by the qanapi API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/qanapi/qanapi-sdk-golang#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return requestconfig.WithDefaultBaseURL("https://SUBDOMAIN.qanapi.cloud/api/v2/")
}
...
func WithAPIKey(value string) RequestOption {
	return requestconfig.RequestOptionFunc(func(r *requestconfig.RequestConfig) error {
		r.APIKey = value
		return r.Apply(WithHeader("x-qanapi-authorization", r.APIKey))
	})
}

// WithSubdomain returns a RequestOption that sets the client setting "subdomain".
